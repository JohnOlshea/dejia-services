        ...
        <>
            <div className=" inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto md:ml-6 sm:pr-0">
                ...
                <div className='hidden lg:block'>
                    <button type="button" className='justify-end text-xl font-semibold bg-transparent py-2 px-4 lg:px-8 navbutton rounded-full transition-all duration-300 ease-in-out hover:bg-navyblue hover:text-white' onClick={openModal}>
                        Request Info
                    </button>
                </div>
            </div>
                            ...
                            >
                                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                    ...
                                    <div className="py-8 lg:py-8 px-4 mx-auto max-w-screen-md">
                                        ...
                                        <p className="mb-8 lg:mb-16 mt-8 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Want to send us a feedback?</p>
