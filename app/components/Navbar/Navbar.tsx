...
const Navbar = () => {
    ...
    return (
        <Disclosure as="nav" className="navbar fixed w-full top-0 bg-white">
            <>
                <div className="mx-auto max-w-7xl p-3 md:p-4 lg:px-8">
                    <div className="relative flex h-12 sm:h-12 items-center transition-all duration-300 ease-in-out">
