...
const names = [
    {
        ...
        posts: '5 Scheduled meetings per week',
        templates: "access to 400+ materials",
        view: "In person and online",
    ...
    },
    {
        ...
        posts: '5 Scheduled meetings per week',
        templates: "access to 600+ materials",
        view: "In person only",
    ...
    },
    {
        ...
        posts: '100 Scheduled meetings per week',
        templates: "access to 800+ materials",
        view: "In person and online",
        support: '24/7 VIP Support',
        category: 'yearly'
    },
    ...
    return (
        <div id="services-section">
            <div className='mx-auto max-w-7xl sm:py-20 lg:px-8 my-16'>
                <h3 className='text-center text-4xl sm:text-65xl font-black'>Choose from one of our affordable plans</h3>
