        ...
        <div className="bg-joinus my-32">
            <div className='mx-auto max-w-2xl lg:max-w-7xl sm:py-4 lg:px-8'>
                ...
                <div className="text-center">
                    ...
                    <h2 className="text-4xl sm:text-6xl font-bold my-6 leading-10">Subscribe to our newsletter</h2>
                    <p className="text-lightblack text-base font-normal">Join our family craven omni memoria patriae zombieland clairvius narcisse religionis sunt diri undead <br /> historiarum. Golums, zombies unrelenting et Raimi fascinati beheading.</p>
                </div>
